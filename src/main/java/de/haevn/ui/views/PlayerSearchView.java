...
import de.haevn.ui.widgets.ProgressWidget;
import de.haevn.ui.widgets.html.H1;
import de.haevn.ui.widgets.html.H3;
import de.haevn.ui.widgets.lookup.*;
...
public class PlayerSearchView extends BorderPane implements IView {
    ...
    public void showError(Throwable ex) {
        Platform.runLater(() -> {
            if (ex instanceof NetworkException network) {
                if (Network.is4xx(network.getStatusCode())) {
                ...
                } else if (Network.is5xx(network.getStatusCode())) {
